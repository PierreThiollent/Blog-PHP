...
!(function (t, e) {
      ...
      fn: function (t) {
        ...
        null != e.modifiersData.popperOffsets &&
          (e.styles.popper = Object.assign(
            ...
            St(Object.assign(Object.assign({}, a), {}, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: s })),
          )),
          null != e.modifiersData.arrow &&
            (e.styles.arrow = Object.assign(
              Object.assign({}, e.styles.arrow),
              St(Object.assign(Object.assign({}, a), {}, { offsets: e.modifiersData.arrow, position: 'absolute', adaptive: !1 })),
            )),
        ...
        for (
          var o = n.mainAxis,
            ...
            b = [m].concat(_).reduce(function (t, n) {
              return t.concat(
                'auto' === mt(n) ? $t(e, { placement: n, boundary: u, rootBoundary: f, padding: c, flipVariations: p, allowedAutoPlacements: g }) : n,
              );
            }, []),
            y = e.rects.reference,
            w = e.rects.popper,
  ...
  function oe(t, e, n) {
    ...
    return (
      (a || (!a && !n)) &&
        (('body' !== ft(e) || Qt(r)) && (l = (i = e) !== dt(i) && pt(i) ? { scrollLeft: (o = i).scrollLeft, scrollTop: o.scrollTop } : Wt(i)),
        ...
        u = {
          ...
          setOptions: function (n) {
            f(),
              ...
              (a.scrollParents = { reference: ht(t) ? Ut(t) : t.contextElement ? Ut(t.contextElement) : [], popper: Ut(e) });
            var o,
              s,
              c = (function (t) {
                var e = re(t);
      ...
      return (
        ...
        (o.dataApiKeydownHandler = function (t) {
          if (
            ...
            if ('Escape' === t.key)
              return (
                (this.matches('[data-bs-toggle="dropdown"]') ? this : q.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(), void o.clearMenus()
              );
            if (n && 'Space' !== t.key) {
      ...
      (o.show = function () {
        ...
        if (
          ...
          if (
            ...
            !(H.trigger(this._element, 'show.bs.tab', { relatedTarget: e }).defaultPrevented || (null !== r && r.defaultPrevented)))
          ) {
  ...
  var Ge = { animation: 'boolean', autohide: 'boolean', delay: 'number' },
    ...
    Je = (function (t) {
      ...
      return (
        ...
        (r._getConfig = function (t) {
          return (
            (t = n({}, Ze, Y.getDataAttributes(this._element), 'object' == typeof t && t ? t : {})), p('toast', t, this.constructor.DefaultType), t
          );
        }),
        (r._setListeners = function () {
          var t = this;
